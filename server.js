...
const Property = mongoose.model('Property', new mongoose.Schema({
  title: String, price: Number, type: String, location: String,
  description: String, media: String, isVideo: Boolean, date: String
}));

const Request = mongoose.model('Request', new mongoose.Schema({
  name: String, phone: String, type: String, message: String,
